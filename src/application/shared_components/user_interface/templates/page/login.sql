...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7537213253622806)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7537595199622807)
,p_page_template_id=>wwv_flow_imp.id(7537213253622806)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7537824444622807)
,p_page_template_id=>wwv_flow_imp.id(7537213253622806)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7538176814622808)
,p_page_template_id=>wwv_flow_imp.id(7537213253622806)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7538408623622808)
,p_page_template_id=>wwv_flow_imp.id(7537213253622806)
,p_name=>'Body Footer'
