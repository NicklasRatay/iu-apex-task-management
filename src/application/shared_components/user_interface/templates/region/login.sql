...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7618708719622987)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7619022855622988)
,p_plug_template_id=>wwv_flow_imp.id(7618708719622987)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7619378541622988)
,p_plug_template_id=>wwv_flow_imp.id(7618708719622987)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7619602858622989)
,p_plug_template_id=>wwv_flow_imp.id(7618708719622987)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7619921185622989)
,p_plug_template_id=>wwv_flow_imp.id(7618708719622987)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7620290085622990)
,p_plug_template_id=>wwv_flow_imp.id(7618708719622987)
,p_name=>'Sub Regions'
