...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7614148827622977)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7614411264622978)
,p_plug_template_id=>wwv_flow_imp.id(7614148827622977)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7614761302622979)
,p_plug_template_id=>wwv_flow_imp.id(7614148827622977)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7615033627622979)
,p_plug_template_id=>wwv_flow_imp.id(7614148827622977)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7615316786622980)
,p_plug_template_id=>wwv_flow_imp.id(7614148827622977)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7615683046622980)
,p_plug_template_id=>wwv_flow_imp.id(7614148827622977)
,p_name=>'Sub Regions'
