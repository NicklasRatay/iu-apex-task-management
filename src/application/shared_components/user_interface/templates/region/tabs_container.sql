...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7633770697623019)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7634086061623020)
,p_plug_template_id=>wwv_flow_imp.id(7633770697623019)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7634333864623020)
,p_plug_template_id=>wwv_flow_imp.id(7633770697623019)
,p_name=>'Tabs'
