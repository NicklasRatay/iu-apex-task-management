...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7616203690622982)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7616567042622982)
,p_plug_template_id=>wwv_flow_imp.id(7616203690622982)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7616873292622983)
,p_plug_template_id=>wwv_flow_imp.id(7616203690622982)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7617134630622983)
,p_plug_template_id=>wwv_flow_imp.id(7616203690622982)
,p_name=>'Button Start'
