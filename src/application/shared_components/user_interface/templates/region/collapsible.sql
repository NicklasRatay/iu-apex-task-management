...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7590809241622928)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7591110114622929)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7591473616622929)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7591790888622929)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7592087081622930)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7592347831622930)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7592623971622931)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7592945337622931)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7593219269622932)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7593572758622932)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7593814234622933)
,p_plug_template_id=>wwv_flow_imp.id(7590809241622928)
,p_name=>'Sub Regions'
