...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7621262663622992)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7621561270622993)
,p_plug_template_id=>wwv_flow_imp.id(7621262663622992)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7621886037622993)
,p_plug_template_id=>wwv_flow_imp.id(7621262663622992)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7622183720622994)
,p_plug_template_id=>wwv_flow_imp.id(7621262663622992)
,p_name=>'Sub Regions'
