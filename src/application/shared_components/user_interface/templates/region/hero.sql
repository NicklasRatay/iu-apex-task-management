...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7600665232622949)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7600909531622950)
,p_plug_template_id=>wwv_flow_imp.id(7600665232622949)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7601221033622951)
,p_plug_template_id=>wwv_flow_imp.id(7600665232622949)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7601582838622951)
,p_plug_template_id=>wwv_flow_imp.id(7600665232622949)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7601889068622951)
,p_plug_template_id=>wwv_flow_imp.id(7600665232622949)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7602146072622952)
,p_plug_template_id=>wwv_flow_imp.id(7600665232622949)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
