...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7584352373622914)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7584632854622914)
,p_plug_template_id=>wwv_flow_imp.id(7584352373622914)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7584944409622915)
,p_plug_template_id=>wwv_flow_imp.id(7584352373622914)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7585247607622915)
,p_plug_template_id=>wwv_flow_imp.id(7584352373622914)
,p_name=>'Sub Regions'
