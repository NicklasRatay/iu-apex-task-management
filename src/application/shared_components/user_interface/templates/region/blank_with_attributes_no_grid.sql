...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7558756847622856)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7559026584622857)
,p_plug_template_id=>wwv_flow_imp.id(7558756847622856)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7559326534622857)
,p_plug_template_id=>wwv_flow_imp.id(7558756847622856)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7559612254622858)
,p_plug_template_id=>wwv_flow_imp.id(7558756847622856)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7559979941622858)
,p_plug_template_id=>wwv_flow_imp.id(7558756847622856)
,p_name=>'Sub Regions'
