...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7641490754623034)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7641777936623035)
,p_plug_template_id=>wwv_flow_imp.id(7641490754623034)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7642048154623035)
,p_plug_template_id=>wwv_flow_imp.id(7641490754623034)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7642395547623036)
,p_plug_template_id=>wwv_flow_imp.id(7641490754623034)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7642653659623036)
,p_plug_template_id=>wwv_flow_imp.id(7641490754623034)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7642946228623037)
,p_plug_template_id=>wwv_flow_imp.id(7641490754623034)
