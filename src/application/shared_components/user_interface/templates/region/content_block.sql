...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7586239997622918)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7586511440622918)
,p_plug_template_id=>wwv_flow_imp.id(7586239997622918)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7586844729622919)
,p_plug_template_id=>wwv_flow_imp.id(7586239997622918)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7587108115622919)
,p_plug_template_id=>wwv_flow_imp.id(7586239997622918)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7587452432622920)
,p_plug_template_id=>wwv_flow_imp.id(7586239997622918)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7587750239622921)
,p_plug_template_id=>wwv_flow_imp.id(7586239997622918)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7588071496622921)
,p_plug_template_id=>wwv_flow_imp.id(7586239997622918)
,p_name=>'Sub Regions'
