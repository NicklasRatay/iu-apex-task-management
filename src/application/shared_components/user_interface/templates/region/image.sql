...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7570214902622883)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7570573828622884)
,p_plug_template_id=>wwv_flow_imp.id(7570214902622883)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7570839736622884)
,p_plug_template_id=>wwv_flow_imp.id(7570214902622883)
,p_name=>'Sub Regions'
