...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(7557375013622853)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7557662869622854)
,p_plug_template_id=>wwv_flow_imp.id(7557375013622853)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7557931676622854)
,p_plug_template_id=>wwv_flow_imp.id(7557375013622853)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7558208447622855)
,p_plug_template_id=>wwv_flow_imp.id(7557375013622853)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7558510463622855)
,p_plug_template_id=>wwv_flow_imp.id(7557375013622853)
,p_name=>'Sub Regions'
