...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7717476110623294)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1807735833304506953)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1807735278292506952)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7718100839623307)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7718417968623308)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7718777368623309)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7719068758623309)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7719314393623310)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7718777368623309)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1807735833304506953)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7719686814623311)
,p_plugin_attribute_id=>wwv_flow_imp.id(7719314393623310)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7720063204623312)
,p_plugin_attribute_id=>wwv_flow_imp.id(7719314393623310)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7720418682623313)
,p_plugin_attribute_id=>wwv_flow_imp.id(7719314393623310)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7720823770623314)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(7719314393623310)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7721138903623315)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7721480686623316)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7721791201623317)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7722044641623322)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7722330272623323)
,p_plugin_attribute_id=>wwv_flow_imp.id(7722044641623322)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7722762203623324)
,p_plugin_attribute_id=>wwv_flow_imp.id(7722044641623322)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7723165122623325)
,p_plugin_attribute_id=>wwv_flow_imp.id(7722044641623322)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7723514280623326)
,p_plugin_attribute_id=>wwv_flow_imp.id(7722044641623322)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7723977476623327)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(7719068758623309)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1807735278292506952)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7724232786623328)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7724503943623329)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7724816319623330)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7725102721623331)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7725408973623332)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7725730890623333)
,p_plugin_attribute_id=>wwv_flow_imp.id(7725408973623332)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7726115788623334)
,p_plugin_attribute_id=>wwv_flow_imp.id(7725408973623332)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7726548792623335)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7726807419623336)
,p_plugin_attribute_id=>wwv_flow_imp.id(7726548792623335)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7727221875623337)
,p_plugin_attribute_id=>wwv_flow_imp.id(7726548792623335)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7727632318623338)
,p_plugin_attribute_id=>wwv_flow_imp.id(7726548792623335)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7728090350623339)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7728361938623340)
,p_plugin_attribute_id=>wwv_flow_imp.id(7728090350623339)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7728718399623341)
,p_plugin_attribute_id=>wwv_flow_imp.id(7728090350623339)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7729163901623342)
,p_plugin_attribute_id=>wwv_flow_imp.id(7728090350623339)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7729535265623343)
,p_plugin_attribute_id=>wwv_flow_imp.id(7728090350623339)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7729992992623344)
,p_plugin_attribute_id=>wwv_flow_imp.id(7728090350623339)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7730329053623345)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(7730673680623346)
,p_plugin_attribute_id=>wwv_flow_imp.id(7730329053623345)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(7731059572623347)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1807938885461653581)
,p_plugin_id=>wwv_flow_imp.id(7717476110623294)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
