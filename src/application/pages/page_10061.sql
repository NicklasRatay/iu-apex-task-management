...
,p_required_patch=>wwv_flow_imp.id(7813536444623658)
,p_dialog_chained=>'N'
,p_protection_level=>'C'
,p_page_component_map=>'25'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7995915405624624)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7996394481624625)
,p_name=>'P10061_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(7995915405624624)
