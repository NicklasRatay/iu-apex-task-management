...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7941222558624364)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(7941351430624364)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7941454845624365)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(7941222558624364)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(7943461332624370)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(7941222558624364)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(7944705053624372)
,p_branch_action=>'f?p=&APP_ID.:10044:&APP_SESSION.::&DEBUG.:RP,10044::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(7941454845624365)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7945173831624373)
,p_name=>'P10043_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(7941351430624364)
,p_prompt=>'Roles'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7945594455624374)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(7945995752624376)
...
,p_lov=>'.'||wwv_flow_imp.id(7946028446624376)||'.'
,p_field_template=>wwv_flow_imp.id(7696313669623172)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(7943563323624370)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(7943461332624370)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(7944211415624371)
,p_event_id=>wwv_flow_imp.id(7943563323624370)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(7947049185624378)
...
,p_process_when_button_id=>wwv_flow_imp.id(7941454845624365)
,p_internal_uid=>7947049185624378
);
